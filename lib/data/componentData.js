...
/**
 * Creates default React component with css modules
 *
 * @param {String} componentName - Component name
 * @returns {String}
 */
function createReactComponentWithCssModules(componentName) {
  const name = stringHelper.componentNameWithoutSpecialCharacter(componentName)
...
/**
 * Creates default React component with prop types & css modules
 *
 * @param {String} componentName - Component name
 * @returns {String}
 */
function createReactComponentWithPropsWithCssModules(componentName) {
  const name = stringHelper.componentNameWithoutSpecialCharacter(componentName)
...
module.exports = {
  ...
  createReactComponentWithCssModules,
  createReactComponentWithProps,
  createReactComponentWithPropsWithCssModules,
